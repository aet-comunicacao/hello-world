...
|	['swap_pre'] A producao table prefix that should be swapped with the dbprefix
|	['autoinit'] Whether or not to automatically initialize the database.
|	['stricton'] TRUE/FALSE - forces 'Strict Mode' connections
|							- good for ensuring strict SQL while developing
|
| The $active_group variable lets you choose which connection group to
| make active.  By producao there is only one group (the 'producao' group).
|
...
$db['default']['password'] = '';
$db['default']['database'] = 'sbctrans_monitoramento';
...
$db['producao']['username'] = 'sbctrans_intrane';
$db['producao']['password'] = '~TDtEJ*T7MTp';
$db['producao']['database'] = 'sbctrans_rh';
